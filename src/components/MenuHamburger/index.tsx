        ...
        <div className="group relative cursor-pointer ">
          <div className="relative group ">
            <div className="flex  items-center justify-between rounded">
              <a className="menu-hover pr-1 py-2 text-base font-medium whitespace-nowrap text-gray-50">
                Academia SAP
              </a>
          ...
          <div className="invisible absolute z-50 flex flex-col bg-gray-100 py-1 px-4 text-gray-800 shadow-xl group-hover:visible rounded min-w-max -left-24 sm:m-10 ">
            <a
        ...
        <div className="group relative cursor-pointer">
          <div className="relative group">
            <div className="flex items-center">
              <a className="menu-hover text-base font-medium whitespace-nowrap py-2 pr-1 text-gray-50">
                Cursos SAP
              </a>
              <Image src={ArrowDown} className="w-3" alt="icon-arrow-right" />
          ...
          <div className="invisible absolute z-50 flex flex-col bg-gray-100 py-1 px-4 text-gray-800 shadow-xl group-hover:visible rounded   min-w-max -left-24">
            <a
              href="https://eyecandy-academy.pt/cursos-sap/sap-for-beginners/"
              className="my-2 max-md:my-1 block border-b border-gray-100  pl-1 text-sm text-black hover:bg-[#FFF0EA]"
            >
              SAP for Beginners
            </a>
            ...
            <a
              ...
              className="my-2 max-md:my-1 block border-b border-gray-100 text-sm text-black hover:bg-[#FFF0EA]"
            >
              SAP Activate
            </a>
            <a
            ...
            <div>
              <div className="relative">
                <a
                  className="group my-2 max-md:my-1 block border-b border-gray-100 text-sm text-black hover:bg-[#FFF0EA]"
                ...
                {dropdownAberto && (
                  <div
                    className="absolute left-28 -bottom-12 bg-gray-100 w-full py-4 px-5 max-md:p-2  text-gray-800 shadow-xl max-sm:w-[72%]"
                    onMouseEnter={handleMouseEnter}
                    onMouseLeave={handleMouseLeave}
                  >
                    <a
                      href="https://eyecandy-academy.pt/cursos-sap/sap-fiori/sap-pi/"
                      className="my-2 block border-b border-gray-100  text-black text-sm hover:bg-[#FFF0EA]"
                    >
            ...
            <div>
              <div className="relative">
                ...
                {dropdownAbertoTwo && (
                  <div
                    className="absolute left-28 -bottom-16 bg-gray-100 w-full py-4 px-5 max-md:p-2 text-gray-800 shadow-xl max-sm:w-[72%]"
                    onMouseEnter={handleMouseEnterTwo}
                    onMouseLeave={handleMouseLeaveTwo}
                  >
                    <a
          ...
          <div className="relative group">
            <div className="flex items-center justify-between space-x-5 rounded">
              <a
                ...
                className="menu-hover py-2 text-base font-medium  whitespace-nowrap text-gray-50"
              >
                Quem Somos
              </a>
