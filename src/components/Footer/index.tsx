...
import logoeye from '../../assets/imgs/eyelogo.svg'
...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#08377C]">
        ...
        <div className="md:flex md:justify-between">
          <div className="my-4 ">
            ...
            <div className="mt-20 lg:flex">
              ...
              <div className="md:max-w-[160px]  md:ml-11">
                <span className="not-italic  text-xs leading-4 text-white">
                  Eyecandy is part of the {''}
                    <a  href="https://eyecandy-academy.pt/" 
          ...
          <div className=" grid sm:grid-cols-1 mr-40 py-4 px-4 ">
            <div>
              <h2 
              className="not-italic  leading-9 font-medium text-white md:text-3xl ">
                Ainda tens dúvidas?
              </h2>
              <h2 className="not-italic font-medium leading-9 text-white mt-2 mb-10 md:mt-4 md:text-[26px] l">
              ...
              <ul className="text-gray-400 font-medium">
                <li className="mt-8 flex">
                  <a
                    ...
                    target="blank"
                    className="flex bg-[#FF7112] rounded-[200px] py-4 px-8 not-italic text-base leading-5 text-white transition duration-300 hover:bg-orange-600 "
                  >
                    <Image
      ...
      <div className="lg:py-2 sm:flex sm:items-center sm:justify-between px-4 py-9 bg-[#023177]">
        <div className="mx-auto w-full max-w-screen-xl lg:py-5 sm:flex sm:items-center sm:justify-between  bg-[#023177]">
