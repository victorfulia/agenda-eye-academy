...
const CourseCard: React.FC<any> = (card) => {
  ...
  <>
     <div className="flex items-center justify-center mb-44 mt-8">
        <Image
        ...
        <div className="w-[285px] h-48 flex-col bg-white rounded-[20px] shadow-xl p-4 absolute mt-[400px]">
          ...
          <div className="flex mt-6 justify-between">
            <a
              href="www"
              className="mr-2 rounded-[200px] bg-orange-600 p-2 items-center px-3  transition duration-300 hover:bg-orange-500 "
            >
